...
<div id="read-story">
    <div id="read-story-right">
        <button class="btn-front change-page-btn"><img src="./designVsReadStory/img/leftArrow.png" alt="" class="arrow-change-page"> </button>
        <div>
        ...
        <button class="btn-next change-page-btn"><img src="./designVsReadStory/img/rightArrow.png" alt="" class="arrow-change-page"> </button>
    </div>
</div>
`
